...
import com.example.a51167.mywork.Adapter.RentAdapter;
...
public class rent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RentAdapter adapter = new RentAdapter(rent.this,R.layout.rent_item, publishDataList);
        Button sortUp=(Button)this.findViewById(R.id.sortUp2);
        Button sortDown=(Button)this.findViewById(R.id.sortDown2);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?>parent, View view, int position, long id){
                ...
                Intent intent = new Intent(rent.this,PublishDetailActivity.class);   //跳转到详细界面
                /*将详细信息传到界面*/
